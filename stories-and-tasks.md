...
```
T1.4 [FE] 🟢 (depende de T1.2 + T1.3) — Integrar SpendingPaceChart na Dashboard
```
Adicionar seção "Ritmo de Gastos" na página `Dashboard.tsx` acima dos gráficos existentes.
...
```json
[
  {"description": "Netflix", "amount": 55.90, "due_date": "2026-03-20", "type": "subscription"},
  {"description": "Parcela 3/10 iPhone", "amount": 450.0, "due_date": "2026-03-18", "type": "installment"}
]
```
